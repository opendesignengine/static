...
<title>Holoseat - /trunk/app-src/tech-demos/mockup/static/js/popper.min.js - Open Design Engine</title>
...
<form action="http://opendesignengine.net/projects/holoseat/repository/entry/trunk/app-src/tech-demos/mockup/static/js/popper.min.js?rev=" id="revision_selector" method="get">  <!-- Branches Dropdown -->
...
<h2><a href="http://opendesignengine.net/projects/holoseat/repository/revisions/74/show">root</a>
    ...
    / <a href="http://opendesignengine.net/projects/holoseat/repository/revisions/74/changes/trunk/app-src/tech-demos/mockup/static/js/popper.min.js">popper.min.js</a>
...
<p>
<a href="http://opendesignengine.net/projects/holoseat/repository/revisions/74/changes/trunk/app-src/tech-demos/mockup/static/js/popper.min.js">History</a> |

    View |


    <a href="http://opendesignengine.net/projects/holoseat/repository/revisions/74/annotate/trunk/app-src/tech-demos/mockup/static/js/popper.min.js">Annotate</a> |

<a href="http://opendesignengine.net/projects/holoseat/repository/revisions/74/raw/trunk/app-src/tech-demos/mockup/static/js/popper.min.js">Download</a>
(18.6 kB)
</p>
...
<tr><th class="line-num" id="L1"><a href="popper.min.js.html#L1">1</a></th><td class="line-code"><pre><span class="c">/*
</pre></td></tr>


<tr><th class="line-num" id="L2"><a href="popper.min.js.html#L2">2</a></th><td class="line-code"><pre> Copyright (C) Federico Zivolo 2017
</pre></td></tr>


<tr><th class="line-num" id="L3"><a href="popper.min.js.html#L3">3</a></th><td class="line-code"><pre> Distributed under the MIT License (license terms are at http://opensource.org/licenses/MIT).
</pre></td></tr>


<tr><th class="line-num" id="L4"><a href="popper.min.js.html#L4">4</a></th><td class="line-code"><pre> */</span>(<span class="kw">function</span>(e,t){<span class="s"><span class="dl">'</span><span class="k">object</span><span class="dl">'</span></span>==<span class="kw">typeof</span> exports&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">undefined</span><span class="dl">'</span></span>!=<span class="kw">typeof</span> module?module.exports=t():<span class="s"><span class="dl">'</span><span class="k">function</span><span class="dl">'</span></span>==<span class="kw">typeof</span> define&amp;&amp;define.amd?define(t):e.Popper=t()})(<span class="lv">this</span>,<span class="kw">function</span>(){<span class="s"><span class="dl">'</span><span class="k">use strict</span><span class="dl">'</span></span>;<span class="kw">function</span> <span class="fu">e</span>(e){<span class="kw">return</span> e&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">[object Function]</span><span class="dl">'</span></span>==={}.toString.call(e)}<span class="kw">function</span> <span class="fu">t</span>(e,t){<span class="kw">if</span>(<span class="i">1</span>!==e.nodeType)<span class="kw">return</span>[];<span class="kw">var</span> o=window.getComputedStyle(e,<span class="pc">null</span>);<span class="kw">return</span> t?o[t]:o}<span class="kw">function</span> <span class="fu">o</span>(e){<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===e.nodeName?e:e.parentNode||e.host}<span class="kw">function</span> <span class="fu">n</span>(e){<span class="kw">if</span>(!e||-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">#document</span><span class="dl">'</span></span>].indexOf(e.nodeName))<span class="kw">return</span> window.document.body;<span class="kw">var</span> i=t(e),r=i.overflow,p=i.overflowX,s=i.overflowY;<span class="kw">return</span> <span class="rx"><span class="dl">/</span><span class="k">(auto|scroll)</span><span class="dl">/</span></span>.test(r+s+p)?e:n(o(e))}<span class="kw">function</span> <span class="fu">r</span>(e){<span class="kw">var</span> o=e&amp;&amp;e.offsetParent,i=o&amp;&amp;o.nodeName;<span class="kw">return</span> i&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>!==i&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>!==i?-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">TD</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">TABLE</span><span class="dl">'</span></span>].indexOf(o.nodeName)&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">static</span><span class="dl">'</span></span>===t(o,<span class="s"><span class="dl">'</span><span class="k">position</span><span class="dl">'</span></span>)?r(o):o:window.document.documentElement}<span class="kw">function</span> <span class="fu">p</span>(e){<span class="kw">var</span> t=e.nodeName;<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>!==t&amp;&amp;(<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===t||r(e.firstElementChild)===e)}<span class="kw">function</span> <span class="fu">s</span>(e){<span class="kw">return</span> <span class="pc">null</span>===e.parentNode?e:s(e.parentNode)}<span class="kw">function</span> <span class="fu">d</span>(e,t){<span class="kw">if</span>(!e||!e.nodeType||!t||!t.nodeType)<span class="kw">return</span> window.document.documentElement;<span class="kw">var</span> o=e.compareDocumentPosition(t)&amp;Node.DOCUMENT_POSITION_FOLLOWING,i=o?e:t,n=o?t:e,a=document.createRange();a.setStart(i,<span class="i">0</span>),a.setEnd(n,<span class="i">0</span>);<span class="kw">var</span> f=a.commonAncestorContainer;<span class="kw">if</span>(e!==f&amp;&amp;t!==f||i.contains(n))<span class="kw">return</span> p(f)?f:r(f);<span class="kw">var</span> l=s(e);<span class="kw">return</span> l.host?d(l.host,t):d(e,s(t).host)}<span class="kw">function</span> <span class="fu">a</span>(e){<span class="kw">var</span> t=<span class="i">1</span>&lt;<span class="lv">arguments</span>.length&amp;&amp;<span class="kw">void</span> <span class="i">0</span>!==<span class="lv">arguments</span>[<span class="i">1</span>]?<span class="lv">arguments</span>[<span class="i">1</span>]:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,o=<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>===t?<span class="s"><span class="dl">'</span><span class="k">scrollTop</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">scrollLeft</span><span class="dl">'</span></span>,i=e.nodeName;<span class="kw">if</span>(<span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>===i||<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===i){<span class="kw">var</span> n=window.document.documentElement,r=window.document.scrollingElement||n;<span class="kw">return</span> r[o]}<span class="kw">return</span> e[o]}<span class="kw">function</span> <span class="fu">f</span>(e,t){<span class="kw">var</span> o=<span class="i">2</span>&lt;<span class="lv">arguments</span>.length&amp;&amp;<span class="kw">void</span> <span class="i">0</span>!==<span class="lv">arguments</span>[<span class="i">2</span>]&amp;&amp;<span class="lv">arguments</span>[<span class="i">2</span>],i=a(t,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>),n=a(t,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>),r=o?-<span class="i">1</span>:<span class="i">1</span>;<span class="kw">return</span> e.top+=i*r,e.bottom+=i*r,e.left+=n*r,e.right+=n*r,e}<span class="kw">function</span> <span class="fu">l</span>(e,t){<span class="kw">var</span> o=<span class="s"><span class="dl">'</span><span class="k">x</span><span class="dl">'</span></span>===t?<span class="s"><span class="dl">'</span><span class="k">Left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">Top</span><span class="dl">'</span></span>,i=<span class="s"><span class="dl">'</span><span class="k">Left</span><span class="dl">'</span></span>==o?<span class="s"><span class="dl">'</span><span class="k">Right</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">Bottom</span><span class="dl">'</span></span>;<span class="kw">return</span>+e[<span class="s"><span class="dl">'</span><span class="k">border</span><span class="dl">'</span></span>+o+<span class="s"><span class="dl">'</span><span class="k">Width</span><span class="dl">'</span></span>].split(<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>)[<span class="i">0</span>]+ +e[<span class="s"><span class="dl">'</span><span class="k">border</span><span class="dl">'</span></span>+i+<span class="s"><span class="dl">'</span><span class="k">Width</span><span class="dl">'</span></span>].split(<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>)[<span class="i">0</span>]}<span class="kw">function</span> <span class="fu">m</span>(e,t,o,i){<span class="kw">return</span> _(t[<span class="s"><span class="dl">'</span><span class="k">offset</span><span class="dl">'</span></span>+e],o[<span class="s"><span class="dl">'</span><span class="k">client</span><span class="dl">'</span></span>+e],o[<span class="s"><span class="dl">'</span><span class="k">offset</span><span class="dl">'</span></span>+e],ie()?o[<span class="s"><span class="dl">'</span><span class="k">offset</span><span class="dl">'</span></span>+e]+i[<span class="s"><span class="dl">'</span><span class="k">margin</span><span class="dl">'</span></span>+(<span class="s"><span class="dl">'</span><span class="k">Height</span><span class="dl">'</span></span>===e?<span class="s"><span class="dl">'</span><span class="k">Top</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">Left</span><span class="dl">'</span></span>)]+i[<span class="s"><span class="dl">'</span><span class="k">margin</span><span class="dl">'</span></span>+(<span class="s"><span class="dl">'</span><span class="k">Height</span><span class="dl">'</span></span>===e?<span class="s"><span class="dl">'</span><span class="k">Bottom</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">Right</span><span class="dl">'</span></span>)]:<span class="i">0</span>)}<span class="kw">function</span> <span class="fu">h</span>(){<span class="kw">var</span> e=window.document.body,t=window.document.documentElement,o=ie()&amp;&amp;window.getComputedStyle(t);<span class="kw">return</span>{<span class="ke">height</span>:m(<span class="s"><span class="dl">'</span><span class="k">Height</span><span class="dl">'</span></span>,e,t,o),<span class="ke">width</span>:m(<span class="s"><span class="dl">'</span><span class="k">Width</span><span class="dl">'</span></span>,e,t,o)}}<span class="kw">function</span> <span class="fu">c</span>(e){<span class="kw">return</span> se({},e,{<span class="ke">right</span>:e.left+e.width,<span class="ke">bottom</span>:e.top+e.height})}<span class="kw">function</span> <span class="fu">g</span>(e){<span class="kw">var</span> o={};<span class="kw">if</span>(ie())<span class="kw">try</span>{o=e.getBoundingClientRect();<span class="kw">var</span> i=a(e,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>),n=a(e,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>);o.top+=i,o.left+=n,o.bottom+=i,o.right+=n}<span class="kw">catch</span>(e){}<span class="kw">else</span> o=e.getBoundingClientRect();<span class="kw">var</span> r={<span class="ke">left</span>:o.left,<span class="ke">top</span>:o.top,<span class="ke">width</span>:o.right-o.left,<span class="ke">height</span>:o.bottom-o.top},p=<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===e.nodeName?h():{},s=p.width||e.clientWidth||r.right-r.left,d=p.height||e.clientHeight||r.bottom-r.top,f=e.offsetWidth-s,m=e.offsetHeight-d;<span class="kw">if</span>(f||m){<span class="kw">var</span> g=t(e);f-=l(g,<span class="s"><span class="dl">'</span><span class="k">x</span><span class="dl">'</span></span>),m-=l(g,<span class="s"><span class="dl">'</span><span class="k">y</span><span class="dl">'</span></span>),r.width-=f,r.height-=m}<span class="kw">return</span> c(r)}<span class="kw">function</span> <span class="fu">u</span>(e,o){<span class="kw">var</span> i=ie(),r=<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===o.nodeName,p=g(e),s=g(o),d=n(e),a=t(o),l=+a.borderTopWidth.split(<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>)[<span class="i">0</span>],m=+a.borderLeftWidth.split(<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>)[<span class="i">0</span>],h=c({<span class="ke">top</span>:p.top-s.top-l,<span class="ke">left</span>:p.left-s.left-m,<span class="ke">width</span>:p.width,<span class="ke">height</span>:p.height});<span class="kw">if</span>(h.marginTop=<span class="i">0</span>,h.marginLeft=<span class="i">0</span>,!i&amp;&amp;r){<span class="kw">var</span> u=+a.marginTop.split(<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>)[<span class="i">0</span>],b=+a.marginLeft.split(<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>)[<span class="i">0</span>];h.top-=l-u,h.bottom-=l-u,h.left-=m-b,h.right-=m-b,h.marginTop=u,h.marginLeft=b}<span class="kw">return</span>(i?o.contains(d):o===d&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>!==d.nodeName)&amp;&amp;(h=f(h,o)),h}<span class="kw">function</span> <span class="fu">b</span>(e){<span class="kw">var</span> t=window.document.documentElement,o=u(e,t),i=_(t.clientWidth,window.innerWidth||<span class="i">0</span>),n=_(t.clientHeight,window.innerHeight||<span class="i">0</span>),r=a(t),p=a(t,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>),s={<span class="ke">top</span>:r-o.top+o.marginTop,<span class="ke">left</span>:p-o.left+o.marginLeft,<span class="ke">width</span>:i,<span class="ke">height</span>:n};<span class="kw">return</span> c(s)}<span class="kw">function</span> <span class="fu">y</span>(e){<span class="kw">var</span> i=e.nodeName;<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>===i||<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===i?!<span class="i">1</span>:<span class="s"><span class="dl">'</span><span class="k">fixed</span><span class="dl">'</span></span>===t(e,<span class="s"><span class="dl">'</span><span class="k">position</span><span class="dl">'</span></span>)||y(o(e))}<span class="kw">function</span> <span class="fu">w</span>(e,t,i,r){<span class="kw">var</span> p={<span class="ke">top</span>:<span class="i">0</span>,<span class="ke">left</span>:<span class="i">0</span>},s=d(e,t);<span class="kw">if</span>(<span class="s"><span class="dl">'</span><span class="k">viewport</span><span class="dl">'</span></span>===r)p=b(s);<span class="kw">else</span>{<span class="kw">var</span> a;<span class="s"><span class="dl">'</span><span class="k">scrollParent</span><span class="dl">'</span></span>===r?(a=n(o(e)),<span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>===a.nodeName&amp;&amp;(a=window.document.documentElement)):<span class="s"><span class="dl">'</span><span class="k">window</span><span class="dl">'</span></span>===r?a=window.document.documentElement:a=r;<span class="kw">var</span> f=u(a,s);<span class="kw">if</span>(<span class="s"><span class="dl">'</span><span class="k">HTML</span><span class="dl">'</span></span>===a.nodeName&amp;&amp;!y(s)){<span class="kw">var</span> l=h(),m=l.height,c=l.width;p.top+=f.top-f.marginTop,p.bottom=m+f.top,p.left+=f.left-f.marginLeft,p.right=c+f.left}<span class="kw">else</span> p=f}<span class="kw">return</span> p.left+=i,p.top+=i,p.right-=i,p.bottom-=i,p}<span class="kw">function</span> <span class="fu">v</span>(e){<span class="kw">var</span> t=e.width,o=e.height;<span class="kw">return</span> t*o}<span class="kw">function</span> <span class="fu">E</span>(e,t,o,i,n){<span class="kw">var</span> r=<span class="i">5</span>&lt;<span class="lv">arguments</span>.length&amp;&amp;<span class="kw">void</span> <span class="i">0</span>!==<span class="lv">arguments</span>[<span class="i">5</span>]?<span class="lv">arguments</span>[<span class="i">5</span>]:<span class="i">0</span>;<span class="kw">if</span>(-<span class="i">1</span>===e.indexOf(<span class="s"><span class="dl">'</span><span class="k">auto</span><span class="dl">'</span></span>))<span class="kw">return</span> e;<span class="kw">var</span> p=w(o,i,r,n),s={<span class="ke">top</span>:{<span class="ke">width</span>:p.width,<span class="ke">height</span>:t.top-p.top},<span class="ke">right</span>:{<span class="ke">width</span>:p.right-t.right,<span class="ke">height</span>:p.height},<span class="ke">bottom</span>:{<span class="ke">width</span>:p.width,<span class="ke">height</span>:p.bottom-t.bottom},<span class="ke">left</span>:{<span class="ke">width</span>:t.left-p.left,<span class="ke">height</span>:p.height}},d=Object.keys(s).map(<span class="kw">function</span>(e){<span class="kw">return</span> se({<span class="ke">key</span>:e},s[e],{<span class="ke">area</span>:v(s[e])})}).sort(<span class="kw">function</span>(e,t){<span class="kw">return</span> t.area-e.area}),a=d.filter(<span class="kw">function</span>(e){<span class="kw">var</span> t=e.width,i=e.height;<span class="kw">return</span> t&gt;=o.clientWidth&amp;&amp;i&gt;=o.clientHeight}),f=<span class="i">0</span>&lt;a.length?a[<span class="i">0</span>].key:d[<span class="i">0</span>].key,l=e.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">1</span>];<span class="kw">return</span> f+(l?<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>+l:<span class="s"><span class="dl">'</span><span class="dl">'</span></span>)}<span class="kw">function</span> <span class="fu">x</span>(e,t,o){<span class="kw">var</span> i=d(t,o);<span class="kw">return</span> u(o,i)}<span class="kw">function</span> <span class="fu">O</span>(e){<span class="kw">var</span> t=window.getComputedStyle(e),o=parseFloat(t.marginTop)+parseFloat(t.marginBottom),i=parseFloat(t.marginLeft)+parseFloat(t.marginRight),n={<span class="ke">width</span>:e.offsetWidth+i,<span class="ke">height</span>:e.offsetHeight+o};<span class="kw">return</span> n}<span class="kw">function</span> <span class="fu">L</span>(e){<span class="kw">var</span> t={<span class="ke">left</span>:<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,<span class="ke">right</span>:<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,<span class="ke">bottom</span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="ke">top</span>:<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>};<span class="kw">return</span> e.replace(<span class="rx"><span class="dl">/</span><span class="k">left|right|bottom|top</span><span class="dl">/</span><span class="mod">g</span></span>,<span class="kw">function</span>(e){<span class="kw">return</span> t[e]})}<span class="kw">function</span> <span class="fu">S</span>(e,t,o){o=o.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>];<span class="kw">var</span> i=O(e),n={<span class="ke">width</span>:i.width,<span class="ke">height</span>:i.height},r=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>].indexOf(o),p=r?<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,s=r?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,d=r?<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>,a=r?<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>;<span class="kw">return</span> n[p]=t[p]+t[d]/<span class="i">2</span>-i[d]/<span class="i">2</span>,n[s]=o===s?t[s]-i[a]:t[L(s)],n}<span class="kw">function</span> <span class="fu">T</span>(e,t){<span class="kw">return</span> Array.prototype.find?e.find(t):e.filter(t)[<span class="i">0</span>]}<span class="kw">function</span> <span class="fu">C</span>(e,t,o){<span class="kw">if</span>(Array.prototype.findIndex)<span class="kw">return</span> e.findIndex(<span class="kw">function</span>(e){<span class="kw">return</span> e[t]===o});<span class="kw">var</span> i=T(e,<span class="kw">function</span>(e){<span class="kw">return</span> e[t]===o});<span class="kw">return</span> e.indexOf(i)}<span class="kw">function</span> <span class="fu">N</span>(t,o,i){<span class="kw">var</span> n=<span class="kw">void</span> <span class="i">0</span>===i?t:t.slice(<span class="i">0</span>,C(t,<span class="s"><span class="dl">'</span><span class="k">name</span><span class="dl">'</span></span>,i));<span class="kw">return</span> n.forEach(<span class="kw">function</span>(t){t.<span class="kw">function</span>&amp;&amp;console.warn(<span class="s"><span class="dl">'</span><span class="k">`modifier.function` is deprecated, use `modifier.fn`!</span><span class="dl">'</span></span>);<span class="kw">var</span> i=t.<span class="kw">function</span>||t.fn;t.enabled&amp;&amp;e(i)&amp;&amp;(o.offsets.popper=c(o.offsets.popper),o.offsets.reference=c(o.offsets.reference),o=i(o,t))}),o}<span class="kw">function</span> <span class="fu">k</span>(){<span class="kw">if</span>(!<span class="lv">this</span>.state.isDestroyed){<span class="kw">var</span> e={<span class="ke">instance</span>:<span class="lv">this</span>,<span class="ke">styles</span>:{},<span class="ke">attributes</span>:{},<span class="ke">flipped</span>:!<span class="i">1</span>,<span class="ke">offsets</span>:{}};e.offsets.reference=x(<span class="lv">this</span>.state,<span class="lv">this</span>.popper,<span class="lv">this</span>.reference),e.placement=E(<span class="lv">this</span>.options.placement,e.offsets.reference,<span class="lv">this</span>.popper,<span class="lv">this</span>.reference,<span class="lv">this</span>.options.modifiers.flip.boundariesElement,<span class="lv">this</span>.options.modifiers.flip.padding),e.originalPlacement=e.placement,e.offsets.popper=S(<span class="lv">this</span>.popper,e.offsets.reference,e.placement),e.offsets.popper.position=<span class="s"><span class="dl">'</span><span class="k">absolute</span><span class="dl">'</span></span>,e=N(<span class="lv">this</span>.modifiers,e),<span class="lv">this</span>.state.isCreated?<span class="lv">this</span>.options.onUpdate(e):(<span class="lv">this</span>.state.isCreated=!<span class="i">0</span>,<span class="lv">this</span>.options.onCreate(e))}}<span class="kw">function</span> <span class="fu">W</span>(e,t){<span class="kw">return</span> e.some(<span class="kw">function</span>(e){<span class="kw">var</span> o=e.name,i=e.enabled;<span class="kw">return</span> i&amp;&amp;o===t})}<span class="kw">function</span> <span class="fu">B</span>(e){<span class="kw">for</span>(<span class="kw">var</span> t=[!<span class="i">1</span>,<span class="s"><span class="dl">'</span><span class="k">ms</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">Webkit</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">Moz</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">O</span><span class="dl">'</span></span>],o=e.charAt(<span class="i">0</span>).toUpperCase()+e.slice(<span class="i">1</span>),n=<span class="i">0</span>;n&lt;t.length-<span class="i">1</span>;n++){<span class="kw">var</span> i=t[n],r=i?<span class="s"><span class="dl">'</span><span class="dl">'</span></span>+i+o:e;<span class="kw">if</span>(<span class="s"><span class="dl">'</span><span class="k">undefined</span><span class="dl">'</span></span>!=<span class="kw">typeof</span> window.document.body.style[r])<span class="kw">return</span> r}<span class="kw">return</span> <span class="pc">null</span>}<span class="kw">function</span> <span class="fu">D</span>(){<span class="kw">return</span> <span class="lv">this</span>.state.isDestroyed=!<span class="i">0</span>,W(<span class="lv">this</span>.modifiers,<span class="s"><span class="dl">'</span><span class="k">applyStyle</span><span class="dl">'</span></span>)&amp;&amp;(<span class="lv">this</span>.popper.removeAttribute(<span class="s"><span class="dl">'</span><span class="k">x-placement</span><span class="dl">'</span></span>),<span class="lv">this</span>.popper.style.left=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>,<span class="lv">this</span>.popper.style.position=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>,<span class="lv">this</span>.popper.style.top=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>,<span class="lv">this</span>.popper.style[B(<span class="s"><span class="dl">'</span><span class="k">transform</span><span class="dl">'</span></span>)]=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>),<span class="lv">this</span>.disableEventListeners(),<span class="lv">this</span>.options.removeOnDestroy&amp;&amp;<span class="lv">this</span>.popper.parentNode.removeChild(<span class="lv">this</span>.popper),<span class="lv">this</span>}<span class="kw">function</span> <span class="fu">H</span>(e,t,o,i){<span class="kw">var</span> r=<span class="s"><span class="dl">'</span><span class="k">BODY</span><span class="dl">'</span></span>===e.nodeName,p=r?window:e;p.addEventListener(t,o,{<span class="ke">passive</span>:!<span class="i">0</span>}),r||H(n(p.parentNode),t,o,i),i.push(p)}<span class="kw">function</span> <span class="fu">P</span>(e,t,o,i){o.updateBound=i,window.addEventListener(<span class="s"><span class="dl">'</span><span class="k">resize</span><span class="dl">'</span></span>,o.updateBound,{<span class="ke">passive</span>:!<span class="i">0</span>});<span class="kw">var</span> r=n(e);<span class="kw">return</span> H(r,<span class="s"><span class="dl">'</span><span class="k">scroll</span><span class="dl">'</span></span>,o.updateBound,o.scrollParents),o.scrollElement=r,o.eventsEnabled=!<span class="i">0</span>,o}<span class="kw">function</span> <span class="fu">A</span>(){<span class="lv">this</span>.state.eventsEnabled||(<span class="lv">this</span>.state=P(<span class="lv">this</span>.reference,<span class="lv">this</span>.options,<span class="lv">this</span>.state,<span class="lv">this</span>.scheduleUpdate))}<span class="kw">function</span> <span class="fu">M</span>(e,t){<span class="kw">return</span> window.removeEventListener(<span class="s"><span class="dl">'</span><span class="k">resize</span><span class="dl">'</span></span>,t.updateBound),t.scrollParents.forEach(<span class="kw">function</span>(e){e.removeEventListener(<span class="s"><span class="dl">'</span><span class="k">scroll</span><span class="dl">'</span></span>,t.updateBound)}),t.updateBound=<span class="pc">null</span>,t.scrollParents=[],t.scrollElement=<span class="pc">null</span>,t.eventsEnabled=!<span class="i">1</span>,t}<span class="kw">function</span> <span class="fu">I</span>(){<span class="lv">this</span>.state.eventsEnabled&amp;&amp;(window.cancelAnimationFrame(<span class="lv">this</span>.scheduleUpdate),<span class="lv">this</span>.state=M(<span class="lv">this</span>.reference,<span class="lv">this</span>.state))}<span class="kw">function</span> <span class="fu">R</span>(e){<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="dl">'</span></span>!==e&amp;&amp;!isNaN(parseFloat(e))&amp;&amp;isFinite(e)}<span class="kw">function</span> <span class="fu">U</span>(e,t){Object.keys(t).forEach(<span class="kw">function</span>(o){<span class="kw">var</span> i=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>;-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>].indexOf(o)&amp;&amp;R(t[o])&amp;&amp;(i=<span class="s"><span class="dl">'</span><span class="k">px</span><span class="dl">'</span></span>),e.style[o]=t[o]+i})}<span class="kw">function</span> <span class="fu">Y</span>(e,t){Object.keys(t).forEach(<span class="kw">function</span>(o){<span class="kw">var</span> i=t[o];!<span class="i">1</span>===i?e.removeAttribute(o):e.setAttribute(o,t[o])})}<span class="kw">function</span> <span class="fu">F</span>(e,t,o){<span class="kw">var</span> i=T(e,<span class="kw">function</span>(e){<span class="kw">var</span> o=e.name;<span class="kw">return</span> o===t}),n=!!i&amp;&amp;e.some(<span class="kw">function</span>(e){<span class="kw">return</span> e.name===o&amp;&amp;e.enabled&amp;&amp;e.order&lt;i.order});<span class="kw">if</span>(!n){<span class="kw">var</span> r=<span class="s"><span class="dl">'</span><span class="k">`</span><span class="dl">'</span></span>+t+<span class="s"><span class="dl">'</span><span class="k">`</span><span class="dl">'</span></span>;console.warn(<span class="s"><span class="dl">'</span><span class="k">`</span><span class="dl">'</span></span>+o+<span class="s"><span class="dl">'</span><span class="k">`</span><span class="dl">'</span></span>+<span class="s"><span class="dl">'</span><span class="k"> modifier is required by </span><span class="dl">'</span></span>+r+<span class="s"><span class="dl">'</span><span class="k"> modifier in order to work, be sure to include it before </span><span class="dl">'</span></span>+r+<span class="s"><span class="dl">'</span><span class="k">!</span><span class="dl">'</span></span>)}<span class="kw">return</span> n}<span class="kw">function</span> <span class="fu">j</span>(e){<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="k">end</span><span class="dl">'</span></span>===e?<span class="s"><span class="dl">'</span><span class="k">start</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">start</span><span class="dl">'</span></span>===e?<span class="s"><span class="dl">'</span><span class="k">end</span><span class="dl">'</span></span>:e}<span class="kw">function</span> <span class="fu">K</span>(e){<span class="kw">var</span> t=<span class="i">1</span>&lt;<span class="lv">arguments</span>.length&amp;&amp;<span class="kw">void</span> <span class="i">0</span>!==<span class="lv">arguments</span>[<span class="i">1</span>]&amp;&amp;<span class="lv">arguments</span>[<span class="i">1</span>],o=ae.indexOf(e),i=ae.slice(o+<span class="i">1</span>).concat(ae.slice(<span class="i">0</span>,o));<span class="kw">return</span> t?i.reverse():i}<span class="kw">function</span> <span class="fu">q</span>(e,t,o,i){<span class="kw">var</span> n=e.match(<span class="rx"><span class="dl">/</span><span class="k">((?:</span><span class="k">\-</span><span class="k">|</span><span class="k">\+</span><span class="k">)?</span><span class="ch">\d</span><span class="k">*</span><span class="k">\.</span><span class="k">?</span><span class="ch">\d</span><span class="k">*)(.*)</span><span class="dl">/</span></span>),r=+n[<span class="i">1</span>],p=n[<span class="i">2</span>];<span class="kw">if</span>(!r)<span class="kw">return</span> e;<span class="kw">if</span>(<span class="i">0</span>===p.indexOf(<span class="s"><span class="dl">'</span><span class="k">%</span><span class="dl">'</span></span>)){<span class="kw">var</span> s;<span class="kw">switch</span>(p){<span class="kw">case</span><span class="s"><span class="dl">'</span><span class="k">%p</span><span class="dl">'</span></span>:s=o;<span class="kw">break</span>;<span class="kw">case</span><span class="s"><span class="dl">'</span><span class="k">%</span><span class="dl">'</span></span>:<span class="kw">case</span><span class="s"><span class="dl">'</span><span class="k">%r</span><span class="dl">'</span></span>:<span class="kw">default</span>:s=i;}<span class="kw">var</span> d=c(s);<span class="kw">return</span> d[t]/<span class="i">100</span>*r}<span class="kw">if</span>(<span class="s"><span class="dl">'</span><span class="k">vh</span><span class="dl">'</span></span>===p||<span class="s"><span class="dl">'</span><span class="k">vw</span><span class="dl">'</span></span>===p){<span class="kw">var</span> a;<span class="kw">return</span> a=<span class="s"><span class="dl">'</span><span class="k">vh</span><span class="dl">'</span></span>===p?_(document.documentElement.clientHeight,window.innerHeight||<span class="i">0</span>):_(document.documentElement.clientWidth,window.innerWidth||<span class="i">0</span>),a/<span class="i">100</span>*r}<span class="kw">return</span> r}<span class="kw">function</span> <span class="fu">G</span>(e,t,o,i){<span class="kw">var</span> n=[<span class="i">0</span>,<span class="i">0</span>],r=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>].indexOf(i),p=e.split(<span class="rx"><span class="dl">/</span><span class="k">(</span><span class="k">\+</span><span class="k">|</span><span class="k">\-</span><span class="k">)</span><span class="dl">/</span></span>).map(<span class="kw">function</span>(e){<span class="kw">return</span> e.trim()}),s=p.indexOf(T(p,<span class="kw">function</span>(e){<span class="kw">return</span>-<span class="i">1</span>!==e.search(<span class="rx"><span class="dl">/</span><span class="k">,|</span><span class="ch">\s</span><span class="dl">/</span></span>)}));p[s]&amp;&amp;-<span class="i">1</span>===p[s].indexOf(<span class="s"><span class="dl">'</span><span class="k">,</span><span class="dl">'</span></span>)&amp;&amp;console.warn(<span class="s"><span class="dl">'</span><span class="k">Offsets separated by white space(s) are deprecated, use a comma (,) instead.</span><span class="dl">'</span></span>);<span class="kw">var</span> d=<span class="rx"><span class="dl">/</span><span class="ch">\s</span><span class="k">*,</span><span class="ch">\s</span><span class="k">*|</span><span class="ch">\s</span><span class="k">+</span><span class="dl">/</span></span>,a=-<span class="i">1</span>===s?[p]:[p.slice(<span class="i">0</span>,s).concat([p[s].split(d)[<span class="i">0</span>]]),[p[s].split(d)[<span class="i">1</span>]].concat(p.slice(s+<span class="i">1</span>))];<span class="kw">return</span> a=a.map(<span class="kw">function</span>(e,i){<span class="kw">var</span> n=(<span class="i">1</span>===i?!r:r)?<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>,p=!<span class="i">1</span>;<span class="kw">return</span> e.reduce(<span class="kw">function</span>(e,t){<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="dl">'</span></span>===e[e.length-<span class="i">1</span>]&amp;&amp;-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">+</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>].indexOf(t)?(e[e.length-<span class="i">1</span>]=t,p=!<span class="i">0</span>,e):p?(e[e.length-<span class="i">1</span>]+=t,p=!<span class="i">1</span>,e):e.concat(t)},[]).map(<span class="kw">function</span>(e){<span class="kw">return</span> q(e,n,t,o)})}),a.forEach(<span class="kw">function</span>(e,t){e.forEach(<span class="kw">function</span>(o,i){R(o)&amp;&amp;(n[t]+=o*(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>===e[i-<span class="i">1</span>]?-<span class="i">1</span>:<span class="i">1</span>))})}),n}<span class="kw">for</span>(<span class="kw">var</span> z=Math.min,V=Math.floor,_=Math.max,X=[<span class="s"><span class="dl">'</span><span class="k">native code</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">[object MutationObserverConstructor]</span><span class="dl">'</span></span>],<span class="fu">Q</span>=<span class="kw">function</span>(e){<span class="kw">return</span> X.some(<span class="kw">function</span>(t){<span class="kw">return</span>-<span class="i">1</span>&lt;(e||<span class="s"><span class="dl">'</span><span class="dl">'</span></span>).toString().indexOf(t)})},J=<span class="s"><span class="dl">'</span><span class="k">undefined</span><span class="dl">'</span></span>!=<span class="kw">typeof</span> window,Z=[<span class="s"><span class="dl">'</span><span class="k">Edge</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">Trident</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">Firefox</span><span class="dl">'</span></span>],<span class="pd">$</span>=<span class="i">0</span>,ee=<span class="i">0</span>;ee&lt;Z.length;ee+=<span class="i">1</span>)<span class="kw">if</span>(J&amp;&amp;<span class="i">0</span>&lt;=navigator.userAgent.indexOf(Z[ee])){<span class="pd">$</span>=<span class="i">1</span>;<span class="kw">break</span>}<span class="kw">var</span> i,te=J&amp;&amp;Q(window.MutationObserver),oe=te?<span class="kw">function</span>(e){<span class="kw">var</span> t=!<span class="i">1</span>,o=<span class="i">0</span>,i=document.createElement(<span class="s"><span class="dl">'</span><span class="k">span</span><span class="dl">'</span></span>),n=<span class="kw">new</span> MutationObserver(<span class="kw">function</span>(){e(),t=!<span class="i">1</span>});<span class="kw">return</span> n.observe(i,{<span class="ke">attributes</span>:!<span class="i">0</span>}),<span class="kw">function</span>(){t||(t=!<span class="i">0</span>,i.setAttribute(<span class="s"><span class="dl">'</span><span class="k">x-index</span><span class="dl">'</span></span>,o),++o)}}:<span class="kw">function</span>(e){<span class="kw">var</span> t=!<span class="i">1</span>;<span class="kw">return</span> <span class="kw">function</span>(){t||(t=!<span class="i">0</span>,setTimeout(<span class="kw">function</span>(){t=!<span class="i">1</span>,e()},<span class="pd">$</span>))}},<span class="fu">ie</span>=<span class="kw">function</span>(){<span class="kw">return</span> <span class="kw">void</span> <span class="i">0</span>==i&amp;&amp;(i=-<span class="i">1</span>!==navigator.appVersion.indexOf(<span class="s"><span class="dl">'</span><span class="k">MSIE 10</span><span class="dl">'</span></span>)),i},<span class="fu">ne</span>=<span class="kw">function</span>(e,t){<span class="kw">if</span>(!(e <span class="kw">instanceof</span> t))<span class="kw">throw</span> <span class="kw">new</span> TypeError(<span class="s"><span class="dl">'</span><span class="k">Cannot call a class as a function</span><span class="dl">'</span></span>)},<span class="fu">re</span>=<span class="kw">function</span>(){<span class="kw">function</span> <span class="fu">e</span>(e,t){<span class="kw">for</span>(<span class="kw">var</span> o,n=<span class="i">0</span>;n&lt;t.length;n++)o=t[n],o.enumerable=o.enumerable||!<span class="i">1</span>,o.configurable=!<span class="i">0</span>,<span class="s"><span class="dl">'</span><span class="k">value</span><span class="dl">'</span></span><span class="kw">in</span> o&amp;&amp;(o.writable=!<span class="i">0</span>),Object.defineProperty(e,o.key,o)}<span class="kw">return</span> <span class="kw">function</span>(t,o,i){<span class="kw">return</span> o&amp;&amp;e(t.prototype,o),i&amp;&amp;e(t,i),t}}(),<span class="fu">pe</span>=<span class="kw">function</span>(e,t,o){<span class="kw">return</span> t <span class="kw">in</span> e?Object.defineProperty(e,t,{<span class="ke">value</span>:o,<span class="ke">enumerable</span>:!<span class="i">0</span>,<span class="ke">configurable</span>:!<span class="i">0</span>,<span class="ke">writable</span>:!<span class="i">0</span>}):e[t]=o,e},se=Object.assign||<span class="kw">function</span>(e){<span class="kw">for</span>(<span class="kw">var</span> t,o=<span class="i">1</span>;o&lt;<span class="lv">arguments</span>.length;o++)<span class="kw">for</span>(<span class="kw">var</span> i <span class="kw">in</span> t=<span class="lv">arguments</span>[o],t)Object.prototype.hasOwnProperty.call(t,i)&amp;&amp;(e[i]=t[i]);<span class="kw">return</span> e},de=[<span class="s"><span class="dl">'</span><span class="k">auto-start</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">auto</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">auto-end</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top-start</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top-end</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right-start</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right-end</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom-end</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom-start</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left-end</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left-start</span><span class="dl">'</span></span>],ae=de.slice(<span class="i">3</span>),fe={<span class="ke">FLIP</span>:<span class="s"><span class="dl">'</span><span class="k">flip</span><span class="dl">'</span></span>,<span class="ke">CLOCKWISE</span>:<span class="s"><span class="dl">'</span><span class="k">clockwise</span><span class="dl">'</span></span>,<span class="ke">COUNTERCLOCKWISE</span>:<span class="s"><span class="dl">'</span><span class="k">counterclockwise</span><span class="dl">'</span></span>},<span class="fu">le</span>=<span class="kw">function</span>(){<span class="kw">function</span> <span class="fu">t</span>(o,i){<span class="kw">var</span> n=<span class="lv">this</span>,r=<span class="i">2</span>&lt;<span class="lv">arguments</span>.length&amp;&amp;<span class="kw">void</span> <span class="i">0</span>!==<span class="lv">arguments</span>[<span class="i">2</span>]?<span class="lv">arguments</span>[<span class="i">2</span>]:{};ne(<span class="lv">this</span>,t),<span class="lv">this</span>.<span class="fu">scheduleUpdate</span>=<span class="kw">function</span>(){<span class="kw">return</span> requestAnimationFrame(n.update)},<span class="lv">this</span>.update=oe(<span class="lv">this</span>.update.bind(<span class="lv">this</span>)),<span class="lv">this</span>.options=se({},t.Defaults,r),<span class="lv">this</span>.state={<span class="ke">isDestroyed</span>:!<span class="i">1</span>,<span class="ke">isCreated</span>:!<span class="i">1</span>,<span class="ke">scrollParents</span>:[]},<span class="lv">this</span>.reference=o.jquery?o[<span class="i">0</span>]:o,<span class="lv">this</span>.popper=i.jquery?i[<span class="i">0</span>]:i,<span class="lv">this</span>.options.modifiers={},Object.keys(se({},t.Defaults.modifiers,r.modifiers)).forEach(<span class="kw">function</span>(e){n.options.modifiers[e]=se({},t.Defaults.modifiers[e]||{},r.modifiers?r.modifiers[e]:{})}),<span class="lv">this</span>.modifiers=Object.keys(<span class="lv">this</span>.options.modifiers).map(<span class="kw">function</span>(e){<span class="kw">return</span> se({<span class="ke">name</span>:e},n.options.modifiers[e])}).sort(<span class="kw">function</span>(e,t){<span class="kw">return</span> e.order-t.order}),<span class="lv">this</span>.modifiers.forEach(<span class="kw">function</span>(t){t.enabled&amp;&amp;e(t.onLoad)&amp;&amp;t.onLoad(n.reference,n.popper,n.options,t,n.state)}),<span class="lv">this</span>.update();<span class="kw">var</span> p=<span class="lv">this</span>.options.eventsEnabled;p&amp;&amp;<span class="lv">this</span>.enableEventListeners(),<span class="lv">this</span>.state.eventsEnabled=p}<span class="kw">return</span> re(t,[{<span class="ke">key</span>:<span class="s"><span class="dl">'</span><span class="k">update</span><span class="dl">'</span></span>,<span class="fu">value</span>:<span class="kw">function</span>(){<span class="kw">return</span> k.call(<span class="lv">this</span>)}},{<span class="ke">key</span>:<span class="s"><span class="dl">'</span><span class="k">destroy</span><span class="dl">'</span></span>,<span class="fu">value</span>:<span class="kw">function</span>(){<span class="kw">return</span> D.call(<span class="lv">this</span>)}},{<span class="ke">key</span>:<span class="s"><span class="dl">'</span><span class="k">enableEventListeners</span><span class="dl">'</span></span>,<span class="fu">value</span>:<span class="kw">function</span>(){<span class="kw">return</span> A.call(<span class="lv">this</span>)}},{<span class="ke">key</span>:<span class="s"><span class="dl">'</span><span class="k">disableEventListeners</span><span class="dl">'</span></span>,<span class="fu">value</span>:<span class="kw">function</span>(){<span class="kw">return</span> I.call(<span class="lv">this</span>)}}]),t}();<span class="kw">return</span> le.Utils=(<span class="s"><span class="dl">'</span><span class="k">undefined</span><span class="dl">'</span></span>==<span class="kw">typeof</span> window?global:window).PopperUtils,le.placements=de,le.Defaults={<span class="ke">placement</span>:<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,<span class="ke">eventsEnabled</span>:!<span class="i">0</span>,<span class="ke">removeOnDestroy</span>:!<span class="i">1</span>,<span class="fu">onCreate</span>:<span class="kw">function</span>(){},<span class="fu">onUpdate</span>:<span class="kw">function</span>(){},<span class="ke">modifiers</span>:{<span class="ke">shift</span>:{<span class="ke">order</span>:<span class="i">100</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e){<span class="kw">var</span> t=e.placement,o=t.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>],i=t.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">1</span>];<span class="kw">if</span>(i){<span class="kw">var</span> n=e.offsets,r=n.reference,p=n.popper,s=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>].indexOf(o),d=s?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,a=s?<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>,f={<span class="ke">start</span>:pe({},d,r[d]),<span class="ke">end</span>:pe({},d,r[d]+r[a]-p[a])};e.offsets.popper=se({},p,f[i])}<span class="kw">return</span> e}},<span class="ke">offset</span>:{<span class="ke">order</span>:<span class="i">200</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e,t){<span class="kw">var</span> o,i=t.offset,n=e.placement,r=e.offsets,p=r.popper,s=r.reference,d=n.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>];<span class="kw">return</span> o=R(+i)?[+i,<span class="i">0</span>]:G(i,p,s,d),<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>===d?(p.top+=o[<span class="i">0</span>],p.left-=o[<span class="i">1</span>]):<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>===d?(p.top+=o[<span class="i">0</span>],p.left+=o[<span class="i">1</span>]):<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>===d?(p.left+=o[<span class="i">0</span>],p.top-=o[<span class="i">1</span>]):<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>===d&amp;&amp;(p.left+=o[<span class="i">0</span>],p.top+=o[<span class="i">1</span>]),e.popper=p,e},<span class="ke">offset</span>:<span class="i">0</span>},<span class="ke">preventOverflow</span>:{<span class="ke">order</span>:<span class="i">300</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e,t){<span class="kw">var</span> o=t.boundariesElement||r(e.instance.popper);e.instance.reference===o&amp;&amp;(o=r(o));<span class="kw">var</span> i=w(e.instance.popper,e.instance.reference,t.padding,o);t.boundaries=i;<span class="kw">var</span> n=t.priority,p=e.offsets.popper,s={<span class="fu">primary</span>:<span class="kw">function</span>(e){<span class="kw">var</span> o=p[e];<span class="kw">return</span> p[e]&lt;i[e]&amp;&amp;!t.escapeWithReference&amp;&amp;(o=_(p[e],i[e])),pe({},e,o)},<span class="fu">secondary</span>:<span class="kw">function</span>(e){<span class="kw">var</span> o=<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>===e?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,n=p[o];<span class="kw">return</span> p[e]&gt;i[e]&amp;&amp;!t.escapeWithReference&amp;&amp;(n=z(p[o],i[e]-(<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>===e?p.width:p.height))),pe({},o,n)}};<span class="kw">return</span> n.forEach(<span class="kw">function</span>(e){<span class="kw">var</span> t=-<span class="i">1</span>===[<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>].indexOf(e)?<span class="s"><span class="dl">'</span><span class="k">secondary</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">primary</span><span class="dl">'</span></span>;p=se({},p,s[t](e))}),e.offsets.popper=p,e},<span class="ke">priority</span>:[<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>],<span class="ke">padding</span>:<span class="i">5</span>,<span class="ke">boundariesElement</span>:<span class="s"><span class="dl">'</span><span class="k">scrollParent</span><span class="dl">'</span></span>},<span class="ke">keepTogether</span>:{<span class="ke">order</span>:<span class="i">400</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e){<span class="kw">var</span> t=e.offsets,o=t.popper,i=t.reference,n=e.placement.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>],r=V,p=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>].indexOf(n),s=p?<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,d=p?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,a=p?<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>;<span class="kw">return</span> o[s]&lt;r(i[d])&amp;&amp;(e.offsets.popper[d]=r(i[d])-o[a]),o[d]&gt;r(i[s])&amp;&amp;(e.offsets.popper[d]=r(i[s])),e}},<span class="ke">arrow</span>:{<span class="ke">order</span>:<span class="i">500</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e,t){<span class="kw">if</span>(!F(e.instance.modifiers,<span class="s"><span class="dl">'</span><span class="k">arrow</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">keepTogether</span><span class="dl">'</span></span>))<span class="kw">return</span> e;<span class="kw">var</span> o=t.element;<span class="kw">if</span>(<span class="s"><span class="dl">'</span><span class="k">string</span><span class="dl">'</span></span>==<span class="kw">typeof</span> o){<span class="kw">if</span>(o=e.instance.popper.querySelector(o),!o)<span class="kw">return</span> e;}<span class="kw">else</span> <span class="kw">if</span>(!e.instance.popper.contains(o))<span class="kw">return</span> console.warn(<span class="s"><span class="dl">'</span><span class="k">WARNING: `arrow.element` must be child of its popper element!</span><span class="dl">'</span></span>),e;<span class="kw">var</span> i=e.placement.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>],n=e.offsets,r=n.popper,p=n.reference,s=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>].indexOf(i),d=s?<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>,a=s?<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,f=s?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,l=s?<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,m=O(o)[d];p[l]-m&lt;r[a]&amp;&amp;(e.offsets.popper[a]-=r[a]-(p[l]-m)),p[a]+m&gt;r[l]&amp;&amp;(e.offsets.popper[a]+=p[a]+m-r[l]);<span class="kw">var</span> h=p[a]+p[d]/<span class="i">2</span>-m/<span class="i">2</span>,g=h-c(e.offsets.popper)[a];<span class="kw">return</span> g=_(z(r[d]-m,g),<span class="i">0</span>),e.arrowElement=o,e.offsets.arrow={},e.offsets.arrow[a]=Math.round(g),e.offsets.arrow[f]=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>,e},<span class="ke">element</span>:<span class="s"><span class="dl">'</span><span class="k">[x-arrow]</span><span class="dl">'</span></span>},<span class="ke">flip</span>:{<span class="ke">order</span>:<span class="i">600</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e,t){<span class="kw">if</span>(W(e.instance.modifiers,<span class="s"><span class="dl">'</span><span class="k">inner</span><span class="dl">'</span></span>))<span class="kw">return</span> e;<span class="kw">if</span>(e.flipped&amp;&amp;e.placement===e.originalPlacement)<span class="kw">return</span> e;<span class="kw">var</span> o=w(e.instance.popper,e.instance.reference,t.padding,t.boundariesElement),i=e.placement.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>],n=L(i),r=e.placement.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">1</span>]||<span class="s"><span class="dl">'</span><span class="dl">'</span></span>,p=[];<span class="kw">switch</span>(t.behavior){<span class="kw">case</span> fe.FLIP:p=[i,n];<span class="kw">break</span>;<span class="kw">case</span> fe.CLOCKWISE:p=K(i);<span class="kw">break</span>;<span class="kw">case</span> fe.COUNTERCLOCKWISE:p=K(i,!<span class="i">0</span>);<span class="kw">break</span>;<span class="kw">default</span>:p=t.behavior;}<span class="kw">return</span> p.forEach(<span class="kw">function</span>(s,d){<span class="kw">if</span>(i!==s||p.length===d+<span class="i">1</span>)<span class="kw">return</span> e;i=e.placement.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>],n=L(i);<span class="kw">var</span> a=e.offsets.popper,f=e.offsets.reference,l=V,m=<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>===i&amp;&amp;l(a.right)&gt;l(f.left)||<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>===i&amp;&amp;l(a.left)&lt;l(f.right)||<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>===i&amp;&amp;l(a.bottom)&gt;l(f.top)||<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>===i&amp;&amp;l(a.top)&lt;l(f.bottom),h=l(a.left)&lt;l(o.left),c=l(a.right)&gt;l(o.right),g=l(a.top)&lt;l(o.top),u=l(a.bottom)&gt;l(o.bottom),b=<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>===i&amp;&amp;h||<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>===i&amp;&amp;c||<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>===i&amp;&amp;g||<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>===i&amp;&amp;u,y=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>].indexOf(i),w=!!t.flipVariations&amp;&amp;(y&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">start</span><span class="dl">'</span></span>===r&amp;&amp;h||y&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">end</span><span class="dl">'</span></span>===r&amp;&amp;c||!y&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">start</span><span class="dl">'</span></span>===r&amp;&amp;g||!y&amp;&amp;<span class="s"><span class="dl">'</span><span class="k">end</span><span class="dl">'</span></span>===r&amp;&amp;u);(m||b||w)&amp;&amp;(e.flipped=!<span class="i">0</span>,(m||b)&amp;&amp;(i=p[d+<span class="i">1</span>]),w&amp;&amp;(r=j(r)),e.placement=i+(r?<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>+r:<span class="s"><span class="dl">'</span><span class="dl">'</span></span>),e.offsets.popper=se({},e.offsets.popper,S(e.instance.popper,e.offsets.reference,e.placement)),e=N(e.instance.modifiers,e,<span class="s"><span class="dl">'</span><span class="k">flip</span><span class="dl">'</span></span>))}),e},<span class="ke">behavior</span>:<span class="s"><span class="dl">'</span><span class="k">flip</span><span class="dl">'</span></span>,<span class="ke">padding</span>:<span class="i">5</span>,<span class="ke">boundariesElement</span>:<span class="s"><span class="dl">'</span><span class="k">viewport</span><span class="dl">'</span></span>},<span class="ke">inner</span>:{<span class="ke">order</span>:<span class="i">700</span>,<span class="ke">enabled</span>:!<span class="i">1</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e){<span class="kw">var</span> t=e.placement,o=t.split(<span class="s"><span class="dl">'</span><span class="k">-</span><span class="dl">'</span></span>)[<span class="i">0</span>],i=e.offsets,n=i.popper,r=i.reference,p=-<span class="i">1</span>!==[<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>].indexOf(o),s=-<span class="i">1</span>===[<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>].indexOf(o);<span class="kw">return</span> n[p?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>]=r[t]-(s?n[p?<span class="s"><span class="dl">'</span><span class="k">width</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">height</span><span class="dl">'</span></span>]:<span class="i">0</span>),e.placement=L(t),e.offsets.popper=c(n),e}},<span class="ke">hide</span>:{<span class="ke">order</span>:<span class="i">800</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e){<span class="kw">if</span>(!F(e.instance.modifiers,<span class="s"><span class="dl">'</span><span class="k">hide</span><span class="dl">'</span></span>,<span class="s"><span class="dl">'</span><span class="k">preventOverflow</span><span class="dl">'</span></span>))<span class="kw">return</span> e;<span class="kw">var</span> t=e.offsets.reference,o=T(e.instance.modifiers,<span class="kw">function</span>(e){<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="k">preventOverflow</span><span class="dl">'</span></span>===e.name}).boundaries;<span class="kw">if</span>(t.bottom&lt;o.top||t.left&gt;o.right||t.top&gt;o.bottom||t.right&lt;o.left){<span class="kw">if</span>(!<span class="i">0</span>===e.hide)<span class="kw">return</span> e;e.hide=!<span class="i">0</span>,e.attributes[<span class="s"><span class="dl">'</span><span class="k">x-out-of-boundaries</span><span class="dl">'</span></span>]=<span class="s"><span class="dl">'</span><span class="dl">'</span></span>}<span class="kw">else</span>{<span class="kw">if</span>(!<span class="i">1</span>===e.hide)<span class="kw">return</span> e;e.hide=!<span class="i">1</span>,e.attributes[<span class="s"><span class="dl">'</span><span class="k">x-out-of-boundaries</span><span class="dl">'</span></span>]=!<span class="i">1</span>}<span class="kw">return</span> e}},<span class="ke">computeStyle</span>:{<span class="ke">order</span>:<span class="i">850</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e,t){<span class="kw">var</span> o=t.x,i=t.y,n=e.offsets.popper,p=T(e.instance.modifiers,<span class="kw">function</span>(e){<span class="kw">return</span><span class="s"><span class="dl">'</span><span class="k">applyStyle</span><span class="dl">'</span></span>===e.name}).gpuAcceleration;<span class="kw">void</span> <span class="i">0</span>!==p&amp;&amp;console.warn(<span class="s"><span class="dl">'</span><span class="k">WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!</span><span class="dl">'</span></span>);<span class="kw">var</span> s,d,a=<span class="kw">void</span> <span class="i">0</span>===p?t.gpuAcceleration:p,f=r(e.instance.popper),l=g(f),m={<span class="ke">position</span>:n.position},h={<span class="ke">left</span>:V(n.left),<span class="ke">top</span>:V(n.top),<span class="ke">bottom</span>:V(n.bottom),<span class="ke">right</span>:V(n.right)},c=<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>===o?<span class="s"><span class="dl">'</span><span class="k">top</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,u=<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>===i?<span class="s"><span class="dl">'</span><span class="k">left</span><span class="dl">'</span></span>:<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>,b=B(<span class="s"><span class="dl">'</span><span class="k">transform</span><span class="dl">'</span></span>);<span class="kw">if</span>(d=<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>==c?-l.height+h.bottom:h.top,s=<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>==u?-l.width+h.right:h.left,a&amp;&amp;b)m[b]=<span class="s"><span class="dl">'</span><span class="k">translate3d(</span><span class="dl">'</span></span>+s+<span class="s"><span class="dl">'</span><span class="k">px, </span><span class="dl">'</span></span>+d+<span class="s"><span class="dl">'</span><span class="k">px, 0)</span><span class="dl">'</span></span>,m[c]=<span class="i">0</span>,m[u]=<span class="i">0</span>,m.willChange=<span class="s"><span class="dl">'</span><span class="k">transform</span><span class="dl">'</span></span>;<span class="kw">else</span>{<span class="kw">var</span> y=<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>==c?-<span class="i">1</span>:<span class="i">1</span>,w=<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>==u?-<span class="i">1</span>:<span class="i">1</span>;m[c]=d*y,m[u]=s*w,m.willChange=c+<span class="s"><span class="dl">'</span><span class="k">, </span><span class="dl">'</span></span>+u}<span class="kw">var</span> v={<span class="ke"><span class="dl">&quot;</span><span class="k">x-placement</span><span class="dl">&quot;</span></span>:e.placement};<span class="kw">return</span> e.attributes=se({},v,e.attributes),e.styles=se({},m,e.styles),e},<span class="ke">gpuAcceleration</span>:!<span class="i">0</span>,<span class="ke">x</span>:<span class="s"><span class="dl">'</span><span class="k">bottom</span><span class="dl">'</span></span>,<span class="ke">y</span>:<span class="s"><span class="dl">'</span><span class="k">right</span><span class="dl">'</span></span>},<span class="ke">applyStyle</span>:{<span class="ke">order</span>:<span class="i">900</span>,<span class="ke">enabled</span>:!<span class="i">0</span>,<span class="fu">fn</span>:<span class="kw">function</span>(e){<span class="kw">return</span> U(e.instance.popper,e.styles),Y(e.instance.popper,e.attributes),e.offsets.arrow&amp;&amp;U(e.arrowElement,e.offsets.arrow),e},<span class="fu">onLoad</span>:<span class="kw">function</span>(e,t,o,i,n){<span class="kw">var</span> r=x(n,t,e),p=E(o.placement,r,t,e,o.modifiers.flip.boundariesElement,o.modifiers.flip.padding);<span class="kw">return</span> t.setAttribute(<span class="s"><span class="dl">'</span><span class="k">x-placement</span><span class="dl">'</span></span>,p),U(t,{<span class="ke">position</span>:<span class="s"><span class="dl">'</span><span class="k">absolute</span><span class="dl">'</span></span>}),o},<span class="ke">gpuAcceleration</span>:<span class="kw">void</span> <span class="i">0</span>}}},le});
</pre></td></tr>


<tr><th class="line-num" id="L5"><a href="popper.min.js.html#L5">5</a></th><td class="line-code"><pre><span class="c">//# sourceMappingURL=popper.min.js.map</span>
</pre></td></tr>
